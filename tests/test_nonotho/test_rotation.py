# import pytest
# import geom
# from polymap.nonortho.rotation import BaseVectorNames, AngleCalc, move_vector
# from polymap.nonortho.interfaces import create_test_lines
# import numpy as np
...
#     assert a.closest_vector_name == closest_vector
#     assert np.isclose(a.smallest_angle, angle)
#     assert a.sign == sign


# def test_rotate_line():
#     v = test_lines.e1.a10.v
#     new_v = move_vector(v)
#     assert is_perp_to_basis_vectors(new_v)
